#if !defined(EXPERIMENTS_POLICY_SUBOPTIMAL_MODEL_ACTOR_CRITIC_HPP_)
#define EXPERIMENTS_POLICY_SUBOPTIMAL_MODEL_ACTOR_CRITIC_HPP_
...
{
    class PolicyIterativeFullProbability : public PolicyDatasetExperiment
    {
      private:
      ...
      public:
        PolicyIterativeFullProbability(uint32_t batch_size,
                                       uint32_t chunk_size,
                                       uint32_t max_epochs,
...
#endif  // EXPERIMENTS_POLICY_SUBOPTIMAL_MODEL_ACTOR_CRITIC_HPP_
