...
{
    torch::Tensor
    NStepReturnFunctionImpl::get(int32_t step_index, int32_t num_steps, double discount, const Trajectory& trajectory, const torch::Device device) const
    {
        ...
        return cumulative_return + cumulative_discount * trajectory.at(max_index - 1).successor_value.detach();
    }
}  // namespace experiments
