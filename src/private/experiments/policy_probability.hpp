#if !defined(EXPERIMENTS_POLICY_PROBABILITY_GRADIENT_HPP_)
#define EXPERIMENTS_POLICY_PROBABILITY_GRADIENT_HPP_
...
namespace experiments
{
    class PolicyProbability
    {
      ...
      public:
        PolicyProbability(uint32_t batch_size,
                          uint32_t max_epochs,
...
#endif  // EXPERIMENTS_POLICY_PROBABILITY_GRADIENT_HPP_
