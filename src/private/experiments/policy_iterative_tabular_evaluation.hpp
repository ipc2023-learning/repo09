#if !defined(EXPERIMENTS_POLICY_TABULAR_ITERATIVE_EVALUATION_HPP_)
#define EXPERIMENTS_POLICY_TABULAR_ITERATIVE_EVALUATION_HPP_
...
{
    class PolicyIterativeTabularEvaluation : public PolicyDatasetExperiment
    {
      private:
      ...
      public:
        PolicyIterativeTabularEvaluation(uint32_t batch_size,
                                         uint32_t chunk_size,
                                         uint32_t max_epochs,
...
#endif  // EXPERIMENTS_POLICY_TABULAR_ITERATIVE_EVALUATION_HPP_
