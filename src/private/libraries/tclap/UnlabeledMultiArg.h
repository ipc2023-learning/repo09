...
namespace TCLAP
{
    ...
    class UnlabeledMultiArg : public MultiArg<T>
    {
      ...
      public:
         ...
         */
        virtual std::string shortID(const std::string&) const { return Arg::getName() + " ..."; }

        /**
         * Returns the a long id string.  Used in the usage.
         * \param val - value to be used.
         */
        virtual std::string longID(const std::string&) const { return Arg::getName() + " (accepted multiple times) <" + _typeDesc + ">"; }
