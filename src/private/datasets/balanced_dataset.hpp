#if !defined(BALANCED_DATASET_HPP_)
#define BALANCED_DATASET_HPP_
...
namespace datasets
{
    class BalancedDataset : public Dataset
    {
      private:
      ...
      public:
        BalancedDataset(const planners::StateSpaceList& state_spaces,
